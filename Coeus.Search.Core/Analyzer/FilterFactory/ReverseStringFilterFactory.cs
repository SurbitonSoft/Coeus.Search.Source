// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ReverseStringFilterFactory.cs" company="Coeus Application Services">
//   Coeus Search 2012
// </copyright>
// <summary>
//   The reverse string filter factory.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Coeus.Search.Core.Analyzer.FilterFactory
{
    ...
    [ExportMetadata("FilterName", "ReverseStringFilter")]
    internal class ReverseStringFilterFactory : TokenFilterFactoryBase
    {
        ...
        {
            return new ReverseStringFilter(Version.LUCENE_40, ts);
        }
